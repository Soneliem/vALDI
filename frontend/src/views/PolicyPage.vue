  ...
  <ion-page>
    <ion-content :fullscreen="true">
      <div class="content">
        ...
        <p>
          sonel.dev built the "vALDI" (also known as vALDI) app as an Open
          Source app. This SERVICE is provided by sonel.dev at no cost and is
          ...
          as in our Terms and Conditions, which are accessible at vALDI unless
        ...
        <p>
          ...
          but not limited to Valorant User IDs and Valorant Access Tokens. The
          information that I request will be retained on your device and
          optionally stored on a secure database if optted in. The app does use
          third-party services that may collect information used to identify
          you. Link to the privacy policy of third-party service providers used
          by the app
        ...
        <p>
          or to assist us in analyzing how our Service is used. I want to inform
        ...
        <p>
          ...
          page. This policy is effective as of 2023-02-04
        </p>
        <h2>Contact Us</h2>
        <p>
          If you have any questions or suggestions about my Privacy Policy, do
          not hesitate to contact me at valdi@sonel.dev.
        </p>
      </div>
